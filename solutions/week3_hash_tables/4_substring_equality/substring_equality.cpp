...
private:
	...
	const long long mult1 = rand() % 30; // The mult should be selected randomly but little due to ovrflow
	const long long mult2 = rand() % 30; // The mult should be selected randomly but little due to ovrflow
